...
public class JsonArray implements Iterable<Object> {
     ...
     * <p>
     * JSON itself has no notion of a temporal types, so this method assumes there is a String value and it contains a ISOString encoded date, which it decodes if found and
     * returns.
     * <p>
     ...
     * <p>
     * JSON has no concept of encoding Enums, so the Enum will be converted to a String using the {@link java.lang.Enum#name} method and the value added as a String.
     *
     * @param value
     *            the value
     ...
     * @return the removed value if removed, null otherwise. If the value is a Map, a {@link JsonObject} is built from this Map and returned. It the value is a List, a
     *         {@link JsonArray} is built form this List and returned.
     */
